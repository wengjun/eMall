...
record OnlineFeatureValue(long valueId, String featureName, String entityKey, String featureValue,
...
record ModelDeployment(long modelId, String modelName, String version, String useCase, ModelStatus status,
    ...
    ModelDeployment changeStatus(ModelStatus nextStatus, String ticket) {
        return new ModelDeployment(modelId, modelName, version, useCase, nextStatus, ticket, createdAt,
                Instant.now());
    }
}
