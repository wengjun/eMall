...
record IdentityAccount(long accountId, IdentityType type, String subject, String displayName, IdentityStatus status,
...
record DeviceSession(long sessionId, long accountId, String deviceId, String accessToken, String refreshToken,
        SessionStatus status, Instant expiresAt, Instant createdAt, Instant updatedAt) {
...
record PermissionGrant(long grantId, long accountId, String scope, String resource, Instant createdAt) {
}

record ServiceClient(long clientId, String clientKey, String secretHash, String scopes, boolean active,
        Instant createdAt, Instant updatedAt) {
}

record MerchantSubAccount(long subAccountId, long merchantId, long accountId, String roleCode, boolean active,
        Instant createdAt, Instant updatedAt) {
}
