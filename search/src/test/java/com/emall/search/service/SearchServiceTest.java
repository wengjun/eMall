...
class SearchServiceTest {
    ...
    void shouldIndexSearchAndDeleteDocument() {
        searchService.index(30001L, "flagship phone", "digital", new BigDecimal("3799.00"),
                Set.of("phone", "hot"), true);
        ...
        assertThat(result.documents())
                .filteredOn(document -> document.skuId() == 30001L)
                .singleElement()
                .satisfies(document -> assertThat(document.saleable()).isTrue());
        assertThatThrownBy(() -> searchService.get(30001L))
