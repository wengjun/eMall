...
record FinOpsAction(long actionId, String serviceName, String actionType, BigDecimal estimatedSaving, OpsStatus status,
        Instant createdAt, Instant updatedAt) {
...
record SecurityOperation(long operationId, String serviceName, String signalType, RiskLevel riskLevel, OpsStatus status,
        Instant createdAt, Instant updatedAt) {
