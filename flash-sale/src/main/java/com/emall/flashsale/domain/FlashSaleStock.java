...
public record FlashSaleStock(long campaignId, long skuId, int totalStock, int availableStock, int tokenReservedStock,
        int queuedStock, int soldStock, Instant updatedAt) {
