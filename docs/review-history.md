...
- 证据：[pom.xml](../migration-runner/pom.xml#L56)、
  ...
  [MigrationRunnerApplication.java](../migration-runner/src/main/java/com/emall/migration/MigrationRunnerApplication.java#L29)，以及历史
  `ops/k8s/migration-runner.yml`（修复时删除，当前迁移部署见
...
- 证据：[ci.yml](../.github/workflows/ci.yml#L3)、[pom.xml](../pom.xml#L25)，以及历史
  `order/src/test/java/com/emall/order/service/ModuleIntegrationTest.java`（修复时删除）。
